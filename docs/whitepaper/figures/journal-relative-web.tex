...
% reciprocal bridges exchange heads; later committed incorporation entangles histories.
\begin{tikzpicture}[
  ...
  \newcommand{\journalhistory}[6]{%
    \begin{scope}[shift={(#2,#3)}, scale=#5, transform shape]
      \node[#6] (#1) at (0,0) {};
      % Simplified current-state DAG glyph: enough to show structure without
      % implying that its tiny internal layout carries semantic detail.
      \node[dag node] (#1-r) at (0,0.22) {};
      \node[dag node] (#1-l) at (-0.24,-0.18) {};
      \node[dag node] (#1-q) at (0.24,-0.18) {};
  ...
  \node[note, right=2mm] at (-4.45,-3.85) {reciprocal bridge relationship};
