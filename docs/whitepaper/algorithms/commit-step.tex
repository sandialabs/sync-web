...
\Function{CommitStep}{$L,t,p_k,s_k$}
  ...
  \State $P[-1] \gets \Call{EmbedDescriptorFields}{P[-1],L.\mathit{name},L.\mathit{endpoint}}$
  \State $C \gets \Call{BlankSigningFields}{P[-1]}$ \Comment{Canonical pre-signature view.}
  \State $d_s \gets \Call{Digest}{C}$
  \State $\sigma \gets \Call{Sign}{s_k,d_s}$
  \State $P[-1] \gets \Call{EmbedSigningMaterial}{P[-1],p_k,\sigma,L.\mathit{interfaceKey}}$
