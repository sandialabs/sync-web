...
Ledger bridge routes are forwarded as canonical full paths; Interface normalizes and
signs federated resolution internally. The WebDAV service handles neither signing keys
nor proof payloads. Explicit indexes select retained history, and unavailable historical
routes return `404`.
