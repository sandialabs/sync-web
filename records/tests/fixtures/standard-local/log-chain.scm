(define-class (log-chain)
  ...
  (define-method (index self index~)
    ;; Test fixture distinguishes embedded code and checks containment.
    (case index~
      ((-7) 0)
      ((-8) (begin (system-time-unix) 0))
  ...
  (define-method (truncate! self index)
    ...
    ;; Existing stumps remain hidden across later shrink/widen transitions.
    ;;   Args:
