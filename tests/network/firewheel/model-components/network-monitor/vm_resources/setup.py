                    ...
                    "targets": [
                        {
                            ...
                            "expr": 'sum by(instance) (rate(social_agent_use_latency_seconds_sum{job="agent-monitor"}[$window])) / clamp_min(sum by(instance) (rate(social_agent_use_latency_seconds_count{job="agent-monitor"}[$window])), 1e-9)',
                            "editorMode": "code",
                            "legendFormat": "{{instance}}",
                            "range": True,
                            "hide": False,
                    ...
                    "targets": [
                        {
                            ...
                            "expr": 'sum by(instance) (rate(social_agent_put_latency_seconds_sum{job="agent-monitor"}[$window])) / clamp_min(sum by(instance) (rate(social_agent_put_latency_seconds_count{job="agent-monitor"}[$window])), 1e-9)',
                            "editorMode": "code",
                            "legendFormat": "{{instance}}",
                            "range": True,
                            "hide": False,
